...
#RNA_file = './data/example_lncRNA.fa'
#Protein_file = './data/example_protein.fa'
...
#PseAAC_file = './data/example_protein_pse_feature'
#PseRNC_file = './data/example_lncRNA_pse_feature'
...
def load_trained():
    ...
    Data_ktuple = np.load('./data/Data_ktuple_RPI488.npy')
    labels = np.load('./data/labels_RPI488.npy')
    index = np.loadtxt('./data/trained_index', dtype = int)
    N1 = 3
    N2 = 100
    N3 = 100
    x_train_1 = Data_kmer[index, :]
    x_train_2 = Data_ktuple[index, :]
    x_train_3 = np.hstack([Data_kmer[index, 0:256], Data_ktuple[index, 22:51]])
    x_train_4 = np.hstack([Data_ktuple[index, 0:22], Data_kmer[index, 256:599]])
    x_train_5 = np.hstack([Data_kmer[index,:], Data_ktuple[index,:]])
    y_train = labels[index,0]
    return x_train_1, x_train_2, x_train_3,x_train_4 ,x_train_5, y_train, N1, N2, N3
...
def LPI_BL_new(pairs_file, lncRNA_fa, protein_fa, lncRNA_pse, protein_pse):
    ...
    for train_index, test_index in skf.split(Data_kmer, y):
        if n == 4:
            break
        x_train_1 = Data_kmer[train_index,:]
        x_train_2 = Data_ktuple[train_index,:]
    ...
    x_train_1, x_train_2, x_train_3,x_train_4 ,x_train_5, y_train, N1, N2, N3 = load_trained()
    x_test_1 = test_kmer
...
#pairs_file = './data/example_pairs.txt'
#lncRNA_fa = './data/example_lncRNA.fa'
#protein_fa = './data/example_protein.fa'
#protein_pse = './data/example_protein_pse_feature'
#lncRNA_pse = './data/example_lncRNA_pse_feature'
